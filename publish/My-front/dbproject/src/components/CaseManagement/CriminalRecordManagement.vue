                ...
                <table style="display: inline-block;text-align: left;">
                    <tr>
                        <td>
                            ...
                            <el-input class="inputBox" v-model="prisonerName" placeholder="请输入姓名" clearable />
                        </td>
                        <td>
                            <el-text class="noteText" type="primary">性别：</el-text>
                            <el-select class="inputBox" v-model="prisonerSex" placeholder="请选择" style="width: 235px">
                    ...
                    <tr>
                        <td>
                            ...
                            <el-input class="inputBox" v-model="prisonerAddress" placeholder="请输入住址" clearable />
                        </td>
                        <td>
                            <el-text class="noteText" type="primary">身份证号：</el-text>
                            <el-input class="inputBox" v-model="prisonerID" placeholder="请输入身份证号码"
                                oninput="value=value.replace(/[^\d.]/g,'')" style="width: 235px" clearable maxlength="18"
                                show-word-limit />
                        </td>
                    </tr>
                </table>
